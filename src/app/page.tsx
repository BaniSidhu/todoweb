          ...
          >
            <h2 id={`accordion-collapse-heading-${section.id}`}>
              <button
                ...
                className="flex items-center justify-between w-full p-5 font-lg bg-[#302640] border-2 border-[#7651AE] text-white rounded-lg focus:ring-[#7651AE] focus:border-[#7651AE]"
            ...
            >
              <div className="p-2 border rounded-lg border-[#7651AE] dark:border-[#7651AE] dark:bg-[#7651AE]">
